...
public class Ballon : MonoBehaviour
{
	...
	public void Create()
	{
		...
		sphere = Instantiate(Resources.Load("balloon")) as GameObject;
		sphere.AddComponent<Rigidbody>();
		sphere.transform.Rotate(180f, 0, 0);
		sphere.transform.position = new Vector3((float)Random.Range(-30, 30), 60, (float)Random.Range(30, 30));
	...
	void Update()
	{
		if (sphere && (sphere.transform.position.y < -40))
			Destroy(sphere);
	}
